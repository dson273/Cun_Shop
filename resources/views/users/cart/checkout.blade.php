                ...
                <div class="w-75">
                    ...
                    @foreach(session('cart', []) as $id => $details)
                        <div class="d-flex flex-column mt-3 border-bottom pb-4">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div style="width: 100px; height: 100px;" class="border rounded-3 overflow-hidden">
                                    <img class="" style="max-width: 100px; max-height: 100px;" src="{{ Storage::url($details['image']) }}" alt="">
                                </div>
                                <div class="ms-3">
                                    <div style="">
                                    ...
                                    <div class="d-flex justify-content-between" style="width:150px; float:right">
                                        ...
                                        <span class="text-secondary">{{ number_format($details['price_sale'] * $details['quantity'], 0, ',', '.') }}₫</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-3 border-bottom pb-4">
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="text-secondary">{{ number_format(array_sum(array_map(function($item) { return $item['price_sale'] * $item['quantity']; }, session('cart', []))), 0, ',', '.') }}₫</span>
                        </div>
                    ...
                    <div class="d-flex justify-content-between mt-2 mt-3">
                        ...
                        <span class="text-primary fw-bold fs-5">{{ number_format(array_sum(array_map(function($item) { return $item['price_sale'] * $item['quantity']; }, session('cart', []))), 0, ',', '.') }}₫</span>
                    </div>
                    <div class="mt-3">

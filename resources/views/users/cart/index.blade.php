    ...
    <section class="py-4" style="min-height: calc(100vh - 409px);">
        <div class="container">
            @if (!session()->has('cart') || empty(session('cart')))
                <h2 class="text-center fw-normal">Giỏ hàng của bạn đang trống!</h2>
            @else
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-3">
                                                        <a href="#"
                                                            class="text-dark text-product text-decoration-none">{{ $details['name'] }}</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="mt-4">
                                                    ...
                                                    <span class="fw-bold text-primary">
                                                        {{ number_format($details['price_sale'], 0, ',', '.') }}₫
                                                    </span>
                                            ...
                                            <td>
                                                <div class="mt-4">
                                                    <form action="{{ route('cart.update', $id) }}" method="POST"
                                                        ...
                                                        @csrf
                                                        <div style="height: 30px; width: 90px;" class="border rounded d-flex justify-content-around">
                                                            <button type="submit" name="quantity"
                                                                value="{{ max($details['quantity'] - 1, 1) }}"
                                                                class="border-0 bg-white"><i class="fa-solid fa-minus"></i></button>
                                                            <input type="text" value="{{ $details['quantity'] }}"
                                                                readonly class="border-0 bg-white text-center"
                                                            ...
                                                            <button type="submit" name="quantity"
                                                                ...
                                                                class="border-0 bg-white"><i class="fa-solid fa-plus fw-light"></i></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="fw-bold text-primary fs-6 mt-4">
                                                    {{ number_format(($details['price_sale'] ?: $details['price']) * $details['quantity'], 0, ',', '.') }}₫
                                                </p>
                                            </td>
                                        </tr>
                                    @endforeach
                        ...
                        <div class="border p-4">
                            ...
                            <div style="border-top: 1px dashed rgb(198, 196, 196); border-bottom: 1px dashed rgb(198, 196, 196);"
                                ...
                                <p class="fw-bold text-primary fs-6">
                                    {{ number_format(array_sum(array_map(function ($item) { return ($item['price_sale'] ?: $item['price']) * $item['quantity']; }, session('cart', []))), 0, ',', '.') }}₫
                                </p>
                            </div>
                            <div>
